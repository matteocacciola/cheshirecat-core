...
class BaseVectorDatabaseHandler(ABC):
    ...
    async def check_embedding_size(self, embedder_name: str, embedder_size: int, collection_name: str) -> bool:
        ...
        This method examines whether the size of the embeddings generated by a specific
        embedder corresponds to the provided expected size for a given collection. This
        is an abstract method and must be implemented by subclasses.

        Args:
            embedder_name (str): The name of the embedder to evaluate.
            embedder_size (int): The expected size of the embeddings generated by the
                embedder.
            collection_name (str): The name of the collection associated with the
                embedder.
    ...
    async def check_collection_existence(self, collection_name: str) -> bool:
        ...
        This method verifies the existence of a specified collection within the
        database. It returns a boolean indicating whether the collection is found
        or not.
...
class QdrantHandler(BaseVectorDatabaseHandler):
    ...
    async def check_embedding_size(self, embedder_name: str, embedder_size: int, collection_name: str) -> bool:
        ...
        same_size = embedder_size == embedder_size
