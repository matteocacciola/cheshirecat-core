...
from cheshirecat.mad_hatter.decorators import CustomEndpoint, CatHook, CatPluginDecorator, CatTool
from cheshirecat.utils import to_camel_case, inspect_calling_agent, get_base_path
...
class Plugin:
    ...
    def _get_py_filename_dotted_notation(self, py_file: str) -> str:
        ...
        return (
            py_file.replace(".py", "")
            .replace("/", ".")
            .replace(base_path_dotted_notation, "cheshirecat.")
        )
