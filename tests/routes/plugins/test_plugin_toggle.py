...
async def test_activate_plugin(secure_client, secure_client_headers):
...
async def test_deactivate_plugin(lizard, secure_client, secure_client_headers):
    # install and activate
    await just_installed_plugin(secure_client, secure_client_headers, activate=True)
...
async def test_reactivate_plugin(secure_client, secure_client_headers):
    # install and activate
    await just_installed_plugin(secure_client, secure_client_headers, activate=True)
...
async def test_deactivate_base_plugin(lizard, secure_client, secure_client_headers):
